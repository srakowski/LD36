...
namespace Coldsteel
{
    public class Layer
    {
        ...
        public bool StickToCamera { get; set; } = false;
        ...
        {
            spriteBatch.Begin(SpriteSortMode, BlendState, SamplerState, null, null, null, (StickToCamera ? (Matrix?)null : camera.TransformationMatrix));
